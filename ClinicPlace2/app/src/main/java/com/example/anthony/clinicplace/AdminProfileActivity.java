...
public class AdminProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        clinicas.add(new Clinica("Juan Pablo","LURI"));
        clinicas.add(new Clinica("Juan Pablo","LURI2"));
        clinicas.add(new Clinica("Juan Pablo","LURI3"));
        clinicas.add(new Clinica("Juan Pablo","LURI4"));
        //GetAllItemsAsyncTask task= new GetAllItemsAsyncTask();
        //task.execute();
         ClinicAdapter itemAdapter =  new ClinicAdapter(this,clinicas);
